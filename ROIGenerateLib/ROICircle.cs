...
namespace ROIGenerateLib
{
    ...
    public class ROICircle : ROI
	{
        ...
        public ROICircle(int imagewidth, int imageheight) : base(imagewidth, imageheight)
        {
            currTitleIndex = ++titleIndex;
            NumHandles = 2; // one at corner of circle + midpoint
            activeHandleIdx = 0;
            ROIConstanceSymbolInfo = EumROIConstanceSymbolInfo.Circle;
        ...
        {
            return string.Format("ROICircle_{0}", currTitleIndex);
