...
namespace ROIGenerateLib
{
    ...
    public class ROIRectangle1 : ROI
	{
        ...
        public ROIRectangle1(int imagewidth, int imageheight) : base(imagewidth, imageheight)
        {
            currTitleIndex= ++titleIndex;
            NumHandles = 5; // 4 corner points + midpoint
			activeHandleIdx = 3;
            ROIConstanceSymbolInfo = EumROIConstanceSymbolInfo.Rectangle1;
        }
        ...
        {
            return string.Format("ROIRectangle1_{0}", currTitleIndex);
        ...
        public override void createROI(double midX, double midY)
		{
			...
			row1 = midR - 5* ActiveBox;
			col1 = midC - 5* ActiveBox;
			row2 = midR + 5* ActiveBox;
			col2 = midC + 5* ActiveBox;
		}
		...
		public override void draw(HalconDotNet.HWindow window)
		{
			...
			window.DispRectangle2(row1, col2, 0, ActiveBox, ActiveBox);
			window.DispRectangle2(row2, col2, 0, ActiveBox, ActiveBox);
			window.DispRectangle2(row2, col1, 0, ActiveBox, ActiveBox);
