...
namespace ROIGenerateLib
{
    ...
    public class ROILine : ROI
	{
        ...
        public ROILine(int imagewidth, int imageheight) : base(imagewidth, imageheight)
        {
            ...
            ROIConstanceSymbolInfo = EumROIConstanceSymbolInfo.Line;
        }
        public ROILine()
        {
            currTitleIndex = ++titleIndex;
        ...
        {
            return string.Format("ROILine_{0}", currTitleIndex);
