...
namespace PositionToolsLib.参数
{
    ...
    /// </summary>
    [Serializable]
   public class GlueOffsetParam : BaseParam
    {
        public GlueOffsetParam()
        {
        ...
        bool glueOffsetRunStatus = false;
        /// <summary>
        /// 工具运行结果状态
        /// </summary>
        [Description("工具运行结果状态"), DefaultValue(false)]
        public bool GlueOffsetRunStatus
        {
            get => glueOffsetRunStatus;
            set
            {
                glueOffsetRunStatus = value;
            }
        }
        #endregion
    }
