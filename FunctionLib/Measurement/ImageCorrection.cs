...
namespace FunctionLib
{
    ...
    /// 图像畸变校正
    /// </summary>
    public partial class ImageCorrection
    {
        ...
        private HTuple hv_CalibDataID;
        /// <summary>
        /// 相机标定句柄
        /// </summary>
        public HTuple Hv_CalibDataID
        {
            get => this.hv_CalibDataID;
            set { this.hv_CalibDataID = value; }
        }
        /// <summary>
        ///  标定前准备返回相机标定句柄
        /// </summary>
        ...
        /// <returns></returns>
        public HTuple ReadyCalibrate(HTuple StartCamPar, HTuple calibObjDescr)
        {
        ...
        /// <returns></returns>
        public HObject OnceCalibrate(HObject ho_Image, HTuple CalibDataID, HTuple calibObjPoseIdx)
        {
        ...
        /// <param name="CalibDataID"></param>
        /// <returns></returns>
        public HTuple CamCalibrate(HTuple CalibDataID, out HTuple hv_Error)
        {
            HTuple hv_CamParam;
        ...
        public void SaveCalibData(HTuple hv_CamParam,string saveDirect)
        {
        ...
        /// <returns></returns>
        public HTuple ReadCalibData(string readDirect)
        {
            try
            {
        ...
        /// <returns></returns>
        public HObject ImageCorret(HObject ho_Image,  HTuple hv_CamParam)
        {
    ...
    /// 图像校正设置助手
    /// </summary>
    public class ImageCorrectionAssistant
    {
        /// <summary>
        /// 生成标定板文件
        /// </summary>
