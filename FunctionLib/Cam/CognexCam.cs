...
{
    public class CognexCam : CamBase, Icam
    {
        public CognexCam(string userName) : base(userName)
        {
        ...
        override public bool OneShot()
        {
            string strfucName = System.Reflection.MethodBase.GetCurrentMethod().ToString();
            StopGrab();
            m_pMyCamera.MV_CC_SetEnumValue_NET("AcquisitionMode", 1);
            m_pMyCamera.MV_CC_SetEnumValue_NET("TriggerMode",0);
        ...
        override public bool SetGain(long dValue)
        {
            ...
            int nRet = m_pMyCamera.MV_CC_SetFloatValue_NET("GainRaw", (float)dValue);
        ...
        override public bool GetGain(out long dValue)
        {
            ...
            if (!IsAlive)
                return false;
            float fGain = 0;
            if (!GetFloatValue("GainRaw", ref fGain))
                return false;
            dValue = (long)fGain;
            return CO_OK;
        }
